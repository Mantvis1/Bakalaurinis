...
namespace test.Tests
{
    public class ScheduleServiceTests
    {
        ...
        public ScheduleServiceTests()
        {
            ...
            var scheduleGenerationService = new ScheduleGenerationService(worksRepository, mockTimeService, userSettingsRepository, mockMessageService,null, _freeSpaceSaver);
